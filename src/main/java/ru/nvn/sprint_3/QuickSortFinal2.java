...
public class QuickSortFinal2 {
   ...
   * *
   *
   * <p>Данный код реализует алгоритм быстрой сортировки (QuickSort) для сортировки массива объектов
   * * Contestant по заданному порядку. Contestant - это класс, который содержит поля имя,
   * количество * решенных задач и штрафное время. Сначала пользователь вводит количество
   * участников, затем для * каждого участника - его имя, количество решенных задач и штрафное
   * время.
   *
   * <p>-- ПРИНЦИП РАБОТЫ --
   *
